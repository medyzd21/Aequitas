...
ACTION_PROFILES: dict[str, GasActionProfile] = {
    ...
    "publish_actuarial_method": GasActionProfile(
        key="publish_actuarial_method",
        label="Publish actuarial method version",
        action_type="Oracle updates",
        actor_type="Actuary",
        contract_function="ActuarialMethodRegistry.registerMethod",
        gas_units=185_000,
        note="Method-version publication when the actuarial proof layer is updated.",
    ),
    "publish_valuation_snapshot": GasActionProfile(
        key="publish_valuation_snapshot",
        label="Publish valuation snapshot",
        action_type="Oracle updates",
        actor_type="Actuary",
        contract_function="ActuarialResultRegistry.publishValuationSnapshot",
        gas_units=155_000,
        note="Compact parameter/input commitment for a valuation run.",
    ),
    "publish_actuarial_result_bundle": GasActionProfile(
        key="publish_actuarial_result_bundle",
        label="Publish actuarial result bundle",
        action_type="Oracle updates",
        actor_type="Actuary",
        contract_function="ActuarialResultRegistry.publishResultBundle",
        gas_units=175_000,
        note="Scheme-level result commitment tied to the declared methods and inputs.",
    ),
...
def build_sandbox_option_b_counts(
    *,
    ...
    steps = [
        ...
        ("publish_piu_price", 1),
        ("publish_mortality_basis", 1),
        ("publish_actuarial_method", 1),
        ("publish_valuation_snapshot", 1),
        ("publish_actuarial_result_bundle", 1),
        ("publish_baseline", 1),
        ("submit_proposal", 1),
        ("publish_stress", 1),
        ("fund_reserve", 1),
