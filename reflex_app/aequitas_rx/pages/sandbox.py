...
def _sandbox_controls() -> rx.Component:
    return rx.box(
        ...
        rx.hstack(
            rx.button("Load sandbox", on_click=AppState.load_demo, color_scheme="indigo", size="2", width="100%"),
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.hstack(
                        ...
                        rx.button("Evaluate locally", on_click=AppState.evaluate_sandbox_proposal, color_scheme="indigo", size="2"),
                        spacing="3",
                        align="center",
                    ),
                    rx.cond(
        ...
        rx.hstack(
            ...
            rx.vstack(
                ...
                rx.cond(
                    ...
                    rx.button("Load sandbox", on_click=AppState.load_demo, size="1", color_scheme="indigo", variant="soft"),
                    rx.cond(
                        row["is_live"] == "yes",
                        rx.button("Open action", on_click=AppState.open_action(row["key"]), size="1", color_scheme="indigo", variant="soft"),
                        rx.fragment(),
                    ),
                ),
                spacing="2",
    ...
    buttons = _panel(
        ...
        rx.hstack(
            rx.button("Generate / load sandbox wallets",
                      on_click=AppState.sandbox_generate_wallets, color_scheme="indigo", size="2"),
            rx.button("Run full Sandbox Sepolia proof demo",
                      on_click=AppState.run_full_sandbox_sepolia_demo, color_scheme="indigo", size="2"),
            spacing="2", wrap="wrap",
        ),
        rx.hstack(
